...
class TestSearchTask:
    ...
    def test_basic_creation(self):
        ...
        task = SearchTask(keyword="Python programming", engine="google")
...
class TestSearchPlan:
    ...
    def test_basic_creation(self):
        ...
        tasks = [SearchTask("Python", "google"), SearchTask("Machine learning", "bing")]

        with patch("time.time", return_value=12345.678):
            plan = SearchPlan(topic="Programming", tasks=tasks, created_at=12345.678)
