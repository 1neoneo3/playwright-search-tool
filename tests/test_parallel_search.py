...
from src.playwright_search.parallel_search import SearchPlanGenerator, ParallelSearchEngine
from src.playwright_search.core.models import SearchResult, SearchTask, SearchPlan, ParallelSearchResult
...
class TestParallelSearchEngine:
    ...
    def mock_search_engine(self):
        ...
        engine.search = AsyncMock(return_value=[
            SearchResult("Test Title", "https://example.com", "Test snippet", 1, "test")
        ])
    ...
    async def test_execute_plan_with_errors(self, sample_plan):
        ...
        success_engine.search = AsyncMock(return_value=[
    ...
    def test_merge_and_deduplicate_results(self):
        ...
        results = {
            ...
            "task2": [
                SearchResult("Title 3", "https://example.com/3", "Snippet 3", 1, "bing"),
                SearchResult("Duplicate", "https://example.com/1", "Different snippet", 2, "bing"),  # Duplicate URL
            ]
        }
    ...
    def test_generate_search_summary(self):
        ...
        # Create test data
        plan = SearchPlan("Test Topic", [
            SearchTask("keyword1", "google"),
            SearchTask("keyword2", "bing")
        ], time.time())
        ...
        results = {
            ...
            "keyword2 (bing)": [
                SearchResult("Title 2", "https://example.com/2", "Snippet 2", 1, "bing"),
            ]
        }
