...
class ResultProcessor:
    ...
    @staticmethod
    def filter_and_sort_by_date(results: List[SearchResult], 
                               recent_only: bool = False, 
                               months: int = 3) -> List[Tuple[SearchResult, float]]:
        """
    ...
    @staticmethod
    def merge_results(result_groups: List[List[SearchResult]], 
    ...
    @staticmethod
    def add_search_context(results: List[SearchResult], context: str) -> List[SearchResult]:
        """
